...
<nav class="bg-white/10 backdrop-blur-md shadow-lg px-6 py-4 fixed w-full top-0 z-50 border-b border-white/10">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <div class="hidden md:flex nav-gap">
            ...
            <div class="relative group">
                <a href="#" class="text-white hover:text-blue-300 font-medium flex items-center gap-1.5 transition">
                    Help
                    <i class="fas fa-chevron-down text-xs opacity-70 mt-0.5"></i>
                </a>
                <div class="absolute left-0 top-full mt-2 w-48 bg-white/10 backdrop-blur-md rounded-xl shadow-xl border border-white/10 py-2 group-hover:flex hidden flex-col z-[110]">
        ...
        <a href="register.php" class="bg-blue-600 text-white px-6 py-2 rounded-lg text-sm font-bold hover:bg-blue-700 transition">
            Sign Up
        </a>
    </div>
</nav>
    ...
    <style>
    /* Custom Tailwind configuration for spacing and dropdown hover */
    @layer utilities {
        .nav-gap {
            gap: 5rem; /* Equivalent to 2 inches / 80px */
        }
    }
    
    /* Dropdown display logic (pure CSS for hover) */
